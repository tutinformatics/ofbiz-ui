...
export class App {
  configureRouter(config, router) {
    ...
    config.map([
      ...
      {
        route: 'new-task',
        moduleId: PLATFORM.moduleName('project/task/task-edit'),
        name: 'new-task',
      },
      {
        route: 'kanban',
      ...
      {
        route: 'projects',
        moduleId: PLATFORM.moduleName('project/project-list'),
        name: 'projects',
        title: 'Projects',
      },
      {
        route: 'projects/:id',
        moduleId: PLATFORM.moduleName('project/task/task-list'),
        name: 'project',
      },
      {
        route: 'new-project',
        moduleId: PLATFORM.moduleName('project/project-new'),
        name: 'newProject',
